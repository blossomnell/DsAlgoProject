...
//		queue.navigateToQueuepage(); 
	...
	public void the_user_navigates_to_the_implementation_of_queue_in_python_page() {
		Assert.assertTrue(queue.isImplementationOfQueueInPythonPageDisplayed(),
				"Implementation of queue in python page is not displayed");
...
//		queue.navigateToTryEditorPage();
	...
	public void the_user_navigates_to_the_implementation_using_collections_deque_page() {
		...
		Assert.assertTrue(queue.isImplementationUsingCollectionDequePageDispayed(),
				"implementation using collections deque page is not displayed");
	}
...
//	queue.navigateToTryEditorPage();
	...
	public void the_user_navigates_to_the_implementation_using_array_page() {
		Assert.assertTrue(queue.isImplementationUsingArrayPageDispayed(),
